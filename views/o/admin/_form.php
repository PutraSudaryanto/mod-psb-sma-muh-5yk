...
<fieldset>
	...
	<div class="clearfix">
		...
		<div class="desc">
			<?php echo $form->textField($model,'register_phone',array('maxlength'=>15)); ?>
	...
	<div class="clearfix">
		...
		<div class="desc">
			<?php echo $form->dropDownList($model,'register_request',array(
				'ipa'=>Yii::t('phrase', 'IPA'),
				'ips'=>Yii::t('phrase', 'IPS'),
			), array('prompt'=>Yii::t('phrase', 'Pilih salah satu'))); ?>
